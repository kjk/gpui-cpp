...
static void PrefixAndSecondaryRangesMatchRust() {
    ...
    utassert(StrSame(prefix.AsStr(), StrL("hello")));
    ...
    utassert(StrSame(full, StrL("Hello World")));
...
static void RenderUsesOneStyledRunAndRealBullets() {
    ...
    utassert(styled && StrSame(styled->text, StrL("Hello World")));
    ...
    utassert(masked && StrSame(masked->text, StrL("••")));
