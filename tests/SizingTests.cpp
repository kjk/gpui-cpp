...
static void NamedAndCustomSizesPreserveTheirValues() {
    ...
    utassert(StrSame(UiSizeAsStr(UiSize::XSmall), StrL("xs")));
    utassert(StrSame(UiSizeAsStr(UiSize::Small), StrL("sm")));
    utassert(StrSame(UiSizeAsStr(UiSize::Medium), StrL("md")));
    utassert(StrSame(UiSizeAsStr(UiSize::Large), StrL("lg")));
    utassert(StrSame(UiSizeAsStr(UiSize::Custom(15)), StrL("custom")));
