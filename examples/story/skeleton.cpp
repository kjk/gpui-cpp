...
El* SkeletonRender(StoryApp* app, Arena* a) {
    ...
    El* sec = StorySection(a, "Default", "Placeholder blocks while content loads.");
    ...
    col->Child(component::Skeleton::New(a)->W(200)->H(14)->Secondary()->IntoEl());
    ...
    lines->Child(component::Skeleton::New(a)->W(180)->H(14)->Secondary()->IntoEl());
    lines->Child(component::Skeleton::New(a)->W(140)->H(14)->Secondary()->IntoEl());
    row->Child(lines);
