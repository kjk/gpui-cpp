...
El* ResizableRender(StoryApp* app, Arena* a) {
    ...
    El* sec = StorySection(a, "Default", "Accessible resizable panel groups and layouts.");
    El* nav = ResizablePanel::New(a)->W(140)->H(kFill)->Pad(8)->FlexCol()->Gap(4);
    ...
    El* main = ResizablePanel::New(a)->Grow()->H(kFill)->Pad(8)->FlexCol()->Gap(8);
    main->Child(StoryTxt(a, StrL("Workspace"), 13, th.foreground));
    main->Child(StoryTxt(a, StrL("Drag the divider to resize navigation."), 12, th.mutedFg)->Wrap()->MaxW(140));
