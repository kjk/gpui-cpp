...
El* SwitchRender(StoryApp* app, Arena* a) {
    ...
    El* sec = StorySection(a, "Default", "A control that allows the user to toggle between checked and not checked.");
    ...
    col->Child(component::Switch::New(a, StrL("airplane"))
                   ...
                   ->IntoEl());
    col->Child(component::Switch::New(a, StrL("disabled-sw"))->Label(StrL("Disabled"))->Disabled(true)->IntoEl());
